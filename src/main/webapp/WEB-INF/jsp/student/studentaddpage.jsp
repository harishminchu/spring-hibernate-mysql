...
<body>
	<div class="container">
		...
		<div class="">
			...
			<c:url var="saveUrl" value="/login/student/students/add" />
			<form:form class="form-horizontal" role="form"
				...
				<div class="form-group">
					...
					<div class="col-sm-2">
						<form:select class="form-control" path="internal">
				...
				<div class="form-group">
					<form:label class="col-sm-2 control-label" style="text-align:left"
						path="subject3">Subject 3</form:label>
					<div class="col-sm-2">
						<form:input class="form-control" path="subject3" />
					</div>
					<form:label class="col-sm-2 control-label" style="text-align:left"
						path="mark3">Marks</form:label>
					<div class="col-sm-2">
						<form:input class="form-control" path="mark3" />
					</div>
					<form:label class="col-sm-2 control-label" style="text-align:left"
						path="percentageoaattendanceforsubject3">Attendance %</form:label>
					<div class="col-sm-2">
						<form:input class="form-control"
				...
				<div class="form-group">
					<form:label class="col-sm-2 control-label" style="text-align:left"
						path="subject4">Subject 4</form:label>
					<div class="col-sm-2">
						<form:input class="form-control" path="subject4" />
					</div>
					<form:label path="mark4" class="col-sm-2 control-label"
						style="text-align:left">Marks</form:label>
					<div class="col-sm-2">
					...
					<form:label class="col-sm-2 control-label" style="text-align:left"
						path="percentageoaattendanceforsubject4">Attendance %</form:label>
					<div class="col-sm-2">
						<form:input class="form-control"
							path="percentageoaattendanceforsubject4" />
					</div>
				</div>
				<div class="form-group">
					<form:label class="col-sm-2 control-label" style="text-align:left"
						path="subject5">Subject 5</form:label>
					<div class="col-sm-2">
						<form:input class="form-control" path="subject5" />
					</div>
					<form:label class="col-sm-2 control-label" style="text-align:left"
						path="mark5">Marks</form:label>
					<div class="col-sm-2">
						<form:input class="form-control" path="mark5" />
					</div>
					<form:label class="col-sm-2 control-label" style="text-align:left"
						path="percentageoaattendanceforsubject5">Attendance %</form:label>
					<div class="col-sm-2">
						<form:input class="form-control"
							path="percentageoaattendanceforsubject5" />
					</div>
				</div>
				<div class="form-group">
					<form:label class="col-sm-2 control-label" style="text-align:left"
						path="subject6">Subject 6</form:label>
					<div class="col-sm-2">
						<form:input class="form-control" path="subject6" />
					</div>
					<form:label class="col-sm-2 control-label" style="text-align:left"
						path="mark6">Marks</form:label>
					<div class="col-sm-2">
						<form:input class="form-control" path="mark6" />
					</div>
					<form:label class="col-sm-2 control-label" style="text-align:left"
						path="percentageoaattendanceforsubject6">Attendance %</form:label>
					<div class="col-sm-2">
						<form:input class="form-control"
							path="percentageoaattendanceforsubject6" />
					</div>

				</div>
				<div class="form-group">
					<form:label class="col-sm-2 control-label" style="text-align:left"
						path="subject7">Subject 7</form:label>
					<div class="col-sm-2">
						<form:input class="form-control" path="subject7" />
					</div>
					<form:label class="col-sm-2 control-label" style="text-align:left"
						path="mark7">Marks</form:label>
					<div class="col-sm-2">
						<form:input class="form-control" path="mark7" />
					</div>
					<form:label class="col-sm-2 control-label" style="text-align:left"
						path="percentageoaattendanceforsubject7">Attendance %</form:label>
					<div class="col-sm-2">
						<form:input class="form-control"
							path="percentageoaattendanceforsubject7" />
					</div>
				</div>
				<div class="form-group">

					<form:label class="col-sm-2 control-label" style="text-align:left"
						path="subject8">Subject 8</form:label>
					<div class="col-sm-2">
						<form:input class="form-control" path="subject8" />
					</div>
					<form:label class="col-sm-2 control-label" style="text-align:left"
						path="mark8">Marks</form:label>
					<div class="col-sm-2">
						<form:input class="form-control" path="mark8" />
					</div>
					<form:label class="col-sm-2 control-label" style="text-align:left"
						path="percentageoaattendanceforsubject8">Attendance %</form:label>
					<div class="col-sm-2">
						<form:input class="form-control"
