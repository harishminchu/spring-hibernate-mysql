...
<script type="text/javascript">
	angular.module('getUttar', []).controller('uttaraCtrl',
			[ '$scope', '$http', function($scope, $http) {
				$http.get('proctorJson').success(function(uttarasList) {
									...
									<thead>
										<tr>
											<th colspan="7"><c:url var="addUrl"
													value="/login/proctor/proctors/add" /> <c:url
													var="editUrl" value="/login/proctor/proctors/edit?id=" />
												<c:url var="deleteUrl"
													value="/login/proctor/proctors/delete?id=" /> <label>Search
